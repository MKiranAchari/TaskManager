...
public class HistoryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        recycler = view.findViewById(R.id.recyclerHistoryTasks);
        recycler.setLayoutManager(new LinearLayoutManager(requireContext()));

        adapter = new TaskAdapter(true, new TaskAdapter.TaskActionListener() {
        ...
        vm.getCompletedTasks().observe(getViewLifecycleOwner(), tasks -> adapter.submitList(tasks));
        return view;
    }
}
